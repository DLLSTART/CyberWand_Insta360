...
| 段 | 文件 | 段高度 / 用途 | 体积 cm³ | PLA g | manifold |
|---|---|---|---:|---:|:---:|
| **D Pommel** | `cyberwand_v51_D_pommel.stl` | 12 mm（含 M24×1×4 空心螺纹凸柱 + USB 方孔贯穿） | 3.21 | 4.0 | ✓ |
| **A Handle** | `cyberwand_v51_A_handle.stl` | 104 mm（外壁平滑 + 凹井按键 + 内部加厚岛 + **PCB 销孔**） | 21.65 | 26.9 | ✓ |
| **B Decor**  | `cyberwand_v51_B_decor.stl`  | 56 mm（雕花结 + 鳞纹带 + 上铜环 ferrule） | 27.35 | 33.9 | ✓ |
| **C Shaft**  | `cyberwand_v51_C_shaft.stl`  | 200 mm（螺旋杖身 + 锥尖） | 15.42 | 19.1 | ✓ |
| **E Button** | `cyberwand_v51_E_button.stl` | 11.5 mm（按键导柱 Φ10 大薄凸缘 + Φ4.6 主柱） | 0.21 | 0.3 | ✓ |
| **F PCB-Pin** | `cyberwand_v51_F_pcb_pin.stl` | 19.5 mm（**PCB 工装锁定销** Φ1.2 主体 + Φ3 装饰头） | 0.03 | 0.04 | ✓ |
| **合计** | — | 368 mm | **67.87** | **~84** | — |
