...
# 下拉电阻（防止悬空）
r_io46_pulldown = R_10K()  # IO46下拉（纯输入引脚，防止悬空噪声）
...
# IO46下拉（防止悬空输入引脚噪声）
# IO46是纯输入引脚，无法通过软件配置内部上下拉，必须外接电阻
...
mcu['IO9'] += spi_sck  # 引脚17, FSPIHD
mcu['IO13'] += spi_mosi  # 引脚21, FSPIQ
mcu['IO12'] += spi_miso  # 引脚20, FSPICLK
mcu['IO14'] += spi_cs_lcd  # 引脚22, FSPIWP
mcu['IO11'] += lcd_dc  # 引脚19, FSPID
mcu['IO17'] += lcd_rst  # 引脚10, IO17
...
mcu['IO10'] += spi_cs_sd  # 引脚18, FSPICS0
...
mcu['IO18'] += uart_tx  # 引脚11, IO18 -> DFPlayer RX
mcu['IO19'] += uart_rx  # 引脚13, IO19 <- DFPlayer TX
mcu['IO20'] += dfplayer_busy  # 引脚14, IO20
...
mcu['IO7'] += i2s_sck  # 引脚7, IO7
mcu['IO15'] += i2s_sd  # 引脚8, IO15
mcu['IO16'] += i2s_ws  # 引脚9, IO16
...
mcu['IO8'] += key_mode_net  # 引脚12, IO8 (TOUCH8)
...
mcu['IO3'] += key_select_net  # 引脚15, IO3 (TOUCH3)
