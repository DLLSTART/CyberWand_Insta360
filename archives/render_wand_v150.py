"""
CyberWand v15.0 - v13.0 等比例放大版
基于 v13.0 等比例放大，容纳 PCB 和电池

放大比例计算：
- v13.0 手柄直径：16mm
- 需要内径：28mm（容纳 PCB 25mm + 壁厚 3mm）
- 放大比例：28/16 = 1.75
...
# 瘤体参数（v13.0 × 1.75）
num_nodes = 9
max_bump_dia = (12.0 * 0.8) * SCALE_FACTOR  # 16.8mm（减少 1/5 后放大）
min_bump_dia = max_bump_dia * (1 - 3/7)  # 9.6mm 顶端最小
min_spacing = 38  # 底部最短间隔（保持不变）
...
def draw_annotations():
    ...
    annotations = [
        ...
        ("尾部瘤体：16.8mm + 间隔 38mm（v13.0 × 1.75）", center_x - 280, center_y + 555),
        ("顶端瘤体：9.6mm + 间隔 55mm", center_x - 280, center_y + 590),
        ("放大比例：1.75×（容纳 PCB 25mm + 电池）", center_x - 280, center_y + 625),
    ]
...
def draw_title():
    ...
    title = "CyberWand v15.0 - v13.0 等比例放大版"
    subtitle = "放大 1.75× | 手柄 28mm | 尾部 16.8mm"
...
# 执行绘制
print("Drawing v13.0 scaled up wand v15.0 (×1.75)...")
draw_wand()
draw_annotations()
draw_title()

# 保存
output_path = r"D:\workspace\CyberWand_Insta360\enclosure\wand_v150_scaled_175.png"
