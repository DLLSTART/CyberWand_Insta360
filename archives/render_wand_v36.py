...
# 圆球节点参数
node_data = [
    {"pos": 25, "shaft_dia": 5.5, "node_dia": 9.0, "spacing": 8},
    {"pos": 18, "shaft_dia": 4.5, "node_dia": 8.0, "spacing": 7},
    {"pos": 12, "shaft_dia": 4.0, "node_dia": 7.0, "spacing": 6},
    {"pos": 7, "shaft_dia": 3.5, "node_dia": 6.0, "spacing": 5},
    {"pos": 3, "shaft_dia": 3.0, "node_dia": 5.0, "spacing": 4},
    {"pos": 0, "shaft_dia": 2.5, "node_dia": 4.5, "spacing": 3},
]
...
def draw_irregular_node(cx, cy, shaft_radius, node_radius):
    ...
    for i in range(num_points):
        ...
        # 椭圆变形（沿杖身方向拉长）
        x = cx + math.cos(angle_i) * radius_variation * 1.2  # X 轴拉长
        y = cy + math.sin(angle_i) * radius_variation * 0.9  # Y 轴压缩
...
def draw_title():
    ...
    title = "CyberWand v3.6 - 不规则圆球形状"
    subtitle = "树瘤状节点 + 椭圆变形 + 表面凹凸"
...
# 执行绘制
print("Drawing irregular nodes...")
draw_wand()
draw_title()

# 保存
output_path = r"D:\workspace\CyberWand_Insta360\enclosure\wand_v36_irregular.png"
