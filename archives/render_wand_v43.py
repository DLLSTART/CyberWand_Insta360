"""
CyberWand v4.3 - 圆球真正长在杖身上
圆球中心 = 杖身轴线，圆球包裹杖身，不悬浮
"""
...
def draw_wand():
    ...
    # 2. 在杖身上添加圆球（圆球中心 = 杖身轴线上的点）
    # 关键：圆球中心在杖身轴线上，圆球半径 > 杖身半径，所以圆球包裹杖身，不悬浮
    for i, node in enumerate(node_data):
        ...
        for ring in range(1, num_rings + 1):
            ...
            for j in range(num_per_ring):
                angle_j = j * 2 * math.pi / num_per_ring + ring * math.pi / num_per_ring
                hx = node_x + math.cos(angle_j) * ring_radius
                hy = node_y + math.sin(angle_j) * ring_radius - node_radius * 0.2
...
def draw_title():
    ...
    title = "CyberWand v4.3 - 圆球真正长在杖身上"
    subtitle = "圆球中心 = 杖身轴线，不悬浮"
...
# 执行绘制
print("Drawing wand with nodes centered on shaft (no floating)...")
draw_wand()
draw_title()

# 保存
output_path = r"D:\workspace\CyberWand_Insta360\enclosure\wand_v43_no_floating.png"
